# Clase 2 - Estructura y Desarrollo HTML (Completed)

Aquí se encuentra la solución completa de la clase 2 mostrando como se elabora la estructura de un sitio web mediante HTML.
